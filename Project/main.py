...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'xxxxxxxxxxxxxx@gmail.com' ")
...
message3 = tk.Label(window, text="Real Time Smart Attendence Management" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
frame4.place(relx=0.27, rely=0.09, relwidth=0.25, relheight=0.07)

datef = tk.Label(frame4,text =   day+"-"+mont[month]+"-"+year+"    |", fg="red",bg="#262523" ,width=55 ,height=1,font=('times', 22, ' bold '))
...
lbl = tk.Label(frame2, text="Roll Number",width=20  ,height=1  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Student Name",width=20  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
